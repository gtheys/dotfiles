...
tm_tunes="#[bg=$base0D,fg=$base02] ♫ #(osascript ~/.dotfiles/applescripts/spotify.scpt | cut -c 1-5)"
...
tm_CPU="#[bg=$base0D,fg=$base02] #(/usr/local/Cellar/tmux-mem-cpu-load/3.4.0/bin/tmux-mem-cpu-load -a 0 -g 0 --interval 2)#[default]"
